...
This script aims to remove the technical aspect of file retrieval from large database from neurosynth. For those using this too with the purpose to enrich and educate our world,  I hope you find this useful.
